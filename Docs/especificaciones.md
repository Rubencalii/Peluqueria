...
* **Frontend Interactivo:** Symfony UX + React.
...
- Sistema de reservas (cliente + admin)
- Gestión de servicios y profesionales
- Calendario con prevención de solapamientos
- Notificaciones por email
- Panel de administración básico
- Pagos en efectivo/datáfono (registro manual)
